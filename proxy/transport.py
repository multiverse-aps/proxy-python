...
class HTTPTransport(object):
    ...
    def send_sync(self, url, method, data=None, json=None, params=None, headers=None, files=None, success_cb=None, failure_cb=None):
        try:
            httpclient = getattr(self.client(), method.lower())
            rv = httpclient(url, params=params, data=data, json=json, headers=headers, files=files, timeout=self.timeout)
            rv.raise_for_status()
